...
<head>
    ...
    <title>Admin Login — Lumiére &amp; Bliss</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Layered background texture — concentric arcs */
        .panel-brand::before {
            content: '';
            position: absolute;
            inset: 0;
        ...
        /* Main brand copy — bottom of panel */
        .brand-copy {
            position: relative;
            z-index: 1;
        }
        ...
        /* Horizontal shimmer line across the panel */
        .shimmer-line {
            position: absolute;
            left: 0; right: 0;
            height: 0.5px;
...
<body>
    ...
    <aside class="panel-brand" aria-hidden="true">
        ...
        <!-- Ambient light orbs — JS positioned below -->
        <div class="shimmer-line"></div>
        <div id="orb-container"></div>

        <div class="brand-copy">
            <div class="eyebrow">Temple of Therapeutic Excellence</div>
            <h1>
                Lumiére<br>
                <em>&amp; Bliss</em>
            </h1>
            ...
            <p class="brand-tagline">
                "Where Healing Light Meets<br>Therapeutic Bliss."
            </p>

            <!-- Condensed brand message -->
            <p>
                A sanctuary where expert touch meets luminous serenity — restoring the spirit, one breath at a time.
            </p>
    ...
    <main class="panel-form">
        <div class="form-wrap">
            ...
            <div class="form-header">
                ...
                <h2>Welcome back</h2>
                <p>Enter the sanctuary management portal — where your work supports every moment of blissful equilibrium.</p>
            </div>
            ...
            <form method="POST" novalidate>
                ...
                <div class="field-group">
                    ...
                    <div class="field-input-wrap">
                        ...
                        >
                            <!-- Eye icon (show) -->
                            <svg id="icon-eye" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <script>
        ...
        /* Ambient light orbs on the brand panel */
        (function() {
            var container = document.getElementById('orb-container');
            var panel     = document.querySelector('.panel-brand');
