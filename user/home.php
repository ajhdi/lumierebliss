...
<style>
    ...
    /* Bold titles for every page except the first (Hero) */
    ...
    .hero-title { 
        ...
        letter-spacing: -1px; 
        margin-bottom: 15px; 
        font-weight: 400; /* Not bold as per your instruction for the first page */
    }
...
<section data-aos="fade-up">
    <div class="container text-center" style="max-width: 850px;">
        ...
        <a href="about.php" class="btn-discover-std mt-4">DISCOVER OUR STORY</a>
    </div>
</section>
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-md-5">
                <div class="membership-brief">
                    ...
                    <a href="promotion.php" class="btn-discover-std">LEARN MORE</a>
                </div>
            </div>
            <div class="col-md-5">
                <div class="membership-brief active-tier">
                    ...
                    <a href="promotion.php" class="btn-luxe btn-gold w-100 text-center">VIEW ALL OFFERS</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row g-0 align-items-center">
            <div class="col-lg-6 d-flex flex-column align-items-center justify-content-center text-center">
                <div class="brand-content-wrapper">
                    ...
                    <a href="therapist.php" class="btn-discover-serif">Discover</a>
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row g-0 align-items-center flex-row-reverse">
            <div class="col-lg-6 d-flex flex-column align-items-center justify-content-center text-center">
                <div class="brand-content-wrapper">
                    ...
                    <a href="treatment.php" class="btn-discover-serif">Discover</a>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="split-image-container">
        ...
        <div class="row g-0 align-items-center">
            <div class="col-lg-6 d-flex flex-column align-items-center justify-content-center text-center">
                <div class="brand-content-wrapper">
                    ...
                    <a href="cosmetics.php" class="btn-discover-serif">Discover</a>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="split-image-container">
        ...
        <div class="row g-0 align-items-center flex-row-reverse">
            <div class="col-lg-6 d-flex flex-column align-items-center justify-content-center text-center">
                <div class="brand-content-wrapper">
                    ...
                    <a href="room.php" class="btn-discover-serif">Discover</a>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="split-image-container">
